...
import com.example.canteenapp.KitchenLogin;
import com.example.canteenapp.KitchenPanel;
...
public class Food extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    databaseReference2=firebaseDatabase.getReference(FireBaseConstant.ORDER_COUNT);
    ...
    fooddone.setOnClickListener(view -> {
      ...
      if (foodname.equals("") | foodprize.equals("") | foodpic.equals("")) {
        ...
        databaseReference2.child(foodname.trim()).child("foodname").setValue(foodname);
        databaseReference2.child(foodname.trim()).child("count").setValue(count);
  ...
  public void onBackPressed() {
    ...
    if (Objects.equals(keyEmail, "admin") && Objects.equals(keyPass, "admin")) {
